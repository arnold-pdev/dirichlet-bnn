...
function learn_by_ukf(𝒩𝒩,ts::Array,σ²=1.0,priors="iid")
    ...
    # add in cross-layer covariance
    # maybe add in time shift for learning? could do same time step, future time step
    # change to varargin: time step, priors, σ\^2, process noise, obs noise, etc.
    ...
    # SUPER WEIRD: this doesn't work when μ = zeros! I think I have an explanation: symmetry
    μ₀ = ones(nₚ)
    ...
    paramnoise = Symmetric(Matrix(0.0001 .*I(nₚ)))
